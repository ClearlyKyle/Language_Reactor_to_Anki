...
document.addEventListener("DOMContentLoaded", function ()
{
    ...
    chrome.storage.local.get('ankiConnectUrl', ({ ankiConnectUrl }) =>
    {
        ...
        ]).then(() =>
        {
            ...
            fetchOptions('ankiFieldWord', url, 'modelFieldNames', { "modelName": model_Name_value })
            fetchOptions('ankiSentence', url, 'modelFieldNames', { "modelName": model_Name_value })
            fetchOptions('ankiSentenceTranslation', url, 'modelFieldNames', { "modelName": model_Name_value })
            fetchOptions('ankiExampleSentence', url, 'modelFieldNames', { "modelName": model_Name_value })
            fetchOptions('ankiBasicTranslation', url, 'modelFieldNames', { "modelName": model_Name_value })
            fetchOptions('ankiExtraTranslation', url, 'modelFieldNames', { "modelName": model_Name_value })
            ...
            submit_button.addEventListener('click', (e) =>
            {
                Promise.all([
                    ...
                    saveOption('ankiSentence'),
                    saveOption('ankiSentenceTranslation'),
                    saveOption('ankiExampleSentence'),
                    saveOption('ankiBasicTranslation'),
                    saveOption('ankiExtraTranslation')
                ])
